...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>84.96954185777308</x>
        <y>56.521375543046005</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>5.555691491499907 0.0 0.0 5.555691491499907 -321.06893126983476 -284.19714337418986</viewport>
    </plugin_config>
    <width>300</width>
    <z>3</z>
    <height>300</height>
